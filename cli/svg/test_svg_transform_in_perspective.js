...
var l0 = R.path("M10 10L100 100").attr({
  stroke: "blue",
  "stroke-width": 2
});
var l1 = R.path("M10 10L100 110").attr({
  stroke: "blue",
  "stroke-width": 2
});
var l2 = R.path("M10 10L100 120").attr({
  stroke: "blue",
  "stroke-width": 2
});
var l3 = R.path("M10 10L100 130").attr({
  stroke: "blue",
  "stroke-width": 2
});
var dl0 = R.path("M10 10L100 130").attr({
  stroke: "red",
  "stroke-width": 2
});
var dl1 = R.path("M10 10L100 130").attr({
  stroke: "red",
  "stroke-width": 2
});
var c0 = R.circle(100, 100, 10).attr({
  fill: "blue",
  stroke: "none"
});
var c1 = R.circle(100, 110, 10).attr({
  fill: "blue",
  stroke: "none"
});
var c2 = R.circle(100, 120, 10).attr({
  fill: "blue",
  stroke: "none"
});
var c3 = R.circle(100, 130, 10).attr({
  fill: "blue",
  stroke: "none"
});
...
function updatelines() {
  $(l0.node).attr({
    d: "M" + c0.attr("cx") + "," + c0.attr("cy") + "L" + c1.attr("cx") + "," + c1.attr("cy")
  });
  $(l1.node).attr({
    d: "M" + c1.attr("cx") + "," + c1.attr("cy") + "L" + c2.attr("cx") + "," + c2.attr("cy")
  });
  $(l2.node).attr({
    d: "M" + c2.attr("cx") + "," + c2.attr("cy") + "L" + c3.attr("cx") + "," + c3.attr("cy")
  });
  $(l3.node).attr({
    d: "M" + c3.attr("cx") + "," + c3.attr("cy") + "L" + c0.attr("cx") + "," + c0.attr("cy")
  });
  ...
  // while distorting
  $(dl0.node).attr({
    d: "M" + c0.attr("cx") + "," + c0.attr("cy") + "L" + c2.attr("cx") + "," + c2.attr("cy")
  });
  $(dl1.node).attr({
    d: "M" + c1.attr("cx") + "," + c1.attr("cy") + "L" + c3.attr("cx") + "," + c3.attr("cy")
  });
}
